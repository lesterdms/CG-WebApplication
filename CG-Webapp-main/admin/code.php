...
if(isset($_POST['add_category_btn'])){
    ...
    $category_query = "INSERT INTO category (category_name,slug,category_desc,meta_title,meta_description,meta_keywords,status,category_popular,category_image)
    ...
    $update_query = "UPDATE category SET category_name='$name', slug='$slug', category_desc='$description', meta_title='$meta_title', meta_description='$meta_description', meta_keywords='$meta_keywords', status='$status', category_popular='$popular', category_image='$update_filename' WHERE id='$category_id' ";
